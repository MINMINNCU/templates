...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="itemBody">
	  ...
	  <?php echo $this->item->event->K2BeforeDisplayContent; ?>
		...
		<?php if( $this->item->params->get('itemImage') && !empty($this->item->image) ||  count($this->item->extra_fields) ): ?>	  
	  <!-- Item Image -->
	  <!-- Item Image -->
	  <div class="itemImageBlock">
		  <span class="itemImage">
		  		...
		  		<?php elseif(count($this->item->extra_fields)):?>	
		  			<img src="<?php echo $this->item->extra_fields[0]->value ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
